/*
 ...
 Author: Richa Manchanda on 4:15:48 PM
 */
package com.wissen.PdfAsg.server.impl;
 ...
 */
public class PdfAsgimpl extends RemoteServiceServlet implements PdfService {
    ...
    String     url      = "jdbc:mysql://localhost:3306/invoice_tmp";

    String     invoice_id, cust_id, cust_name, cust_addr, description, amount, subtotal, taxrate, tax, other, total;

    public String viewPdf() {
        
        try {
            Document document = new Document();
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("FlightTicket.pdf"));
            document.open();
            getData();
            ...
            PdfPCell date = new PdfPCell(new Paragraph("DATE :", new Font(Font.TIMES_ROMAN, 12, Font.BOLD)));
           ...
           // DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            ...
            PdfPCell dt = new PdfPCell(new Paragraph("June 17 2009", new Font(Font.TIMES_ROMAN, 12, Font.BOLD)));
            ...
            PdfPCell invoice = new PdfPCell(new Paragraph("INVOICE#", new Font(Font.TIMES_ROMAN, 12, Font.BOLD)));
            ...
            PdfPCell inv = new PdfPCell(new Paragraph(invoice_id, new Font(Font.TIMES_ROMAN, 12, Font.BOLD)));
            inv.setHorizontalAlignment(Element.ALIGN_CENTER);
            pdftable.addCell(inv);

            PdfPCell customer = new PdfPCell(new Paragraph("CustomerID", new Font(Font.TIMES_ROMAN, 12, Font.BOLD)));
            ...
            PdfPCell cust = new PdfPCell(new Paragraph(cust_id, new Font(Font.TIMES_ROMAN, 12, Font.BOLD)));
            ...
            Phrase address2 = new Phrase("New Pandit Colony, Nasik, Maharashtra, India");
            ...
            PdfPCell cell1 = new PdfPCell(new Paragraph("DESCRIPTION", fontbill));
            ...
            PdfPCell subtotalval = new PdfPCell(new Paragraph("$" + this.subtotal + ".00"));
            ...
            PdfPCell taxrateval = new PdfPCell(new Paragraph(this.taxrate + ".000%"));
            ...
            PdfPCell taxval = new PdfPCell(new Paragraph("$" + this.tax + ".00"));
            ...
            PdfPCell otherval = new PdfPCell(new Paragraph("$" + this.other + ".00"));
            ...
            PdfPCell totalval = new PdfPCell(new Paragraph("$" + this.total + ".00"));
            ...
            PdfPCell commentcell = new PdfPCell(new Paragraph("OTHER COMMENTS", comments));
            ...
            commenttable.setWidthPercentage(50);

            Phrase comment = new Phrase("1.Total Payments Due in 30 days.", new Font(Font.TIMES_ROMAN, 12));
            ...
            Chunk footer1=new Chunk("Page 1");
            Phrase lastmsg = new Phrase("If you have any questions about this invoice,please contact");
            ...
            emlid.setAnchor("http://google.com");
            lastmsg.add(emlid);
    ...
    public void getData() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                //System.out.println(invoice_id + cust_id + cust_addr + cust_name + description + amount + subtotal + taxrate + tax + other + total);
            }
            else {
            ...
            System.out.println("Sorry SQL Error :: " + e);
        }
    }
    ...
    public void closeconnection() {
        try {
            ...
            System.out.println("Error in closeing database : " + e);
        }
    }
}
